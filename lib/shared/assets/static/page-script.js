...
function searchPendingTests(data) {
    ...
    return Object.keys(tests).filter((testId) => tests[testId].targetingMode === 'waituntil' && tests[testId].status === 'pending');
}
/**
...
function sendData(data) {
    document.dispatchEvent(new window.CustomEvent('sendABTastyObject', {
        detail: {
