...
const list_1 = __importDefault(require("../../components/list/assets/scripts/list"));
const detail_1 = __importDefault(require("../../components/detail/assets/scripts/detail"));
const empty_1 = __importDefault(require("shared/empty/assets/scripts/empty"));
const validate_target_1 = __importDefault(require("validate-target"));
const data_manager_1 = __importDefault(require("shared/utils/data-manager"));
class Popup {
    constructor({ data }) {
        this.data = data;
        ...
        this.dataManager = new data_manager_1.default({ data });
        this.templates = {
            empty: () => <empty_1.default />,
            list: () => <list_1.default data={this.dataManager.testsSortedByStatus}/>,
            detail: (id) => (<detail_1.default id={id} result={this.data.results[id]} targetingSorted={this.dataManager.targetingsSortedByStatus[id]} targetingMode={this.data.accountData.tests[id].targetingMode}/>)
        };
    }
    /**
    ...
    onClickOnApp(e) {
        ...
        const validateTargetTargetingButton = validate_target_1.default({
            target: target,
